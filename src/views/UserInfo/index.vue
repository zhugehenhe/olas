...
import AskRecordVue from "./askRecord.vue";
import MyPost from "./myPost.vue";
import LawyerUser from "./lawyerUser.vue";
...
<template>
  <div class="userinfo">
    <el-tabs type="border-card" v-model="activeName" tab-position="left">
      ...
      <el-tab-pane label="律师信息" name="LawyerUser"
      ...
      <el-tab-pane label="我的咨询" name="AskRecordVue"
        ><AskRecordVue v-if="activeName === 'AskRecordVue'"
      /></el-tab-pane>
      <el-tab-pane label="咨询记录" name="Record"
        ><Record v-if="activeName === 'Record' && user.role === 1"
      /></el-tab-pane>
    </el-tabs>
  </div>
</template>
